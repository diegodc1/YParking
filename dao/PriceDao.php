...
class PriceDaoDB implements PriceDao {
  ...
  public function add(Price $u){
    $sql = $this->pdo->prepare("INSERT INTO prices (prc_car_15, prc_car_30, prc_car_1h, prc_car_2h, prc_car_3h, prc_car_6h, prc_car_day, prc_mtbike_15, prc_mtbike_30, prc_mtbike_1h, prc_mtbike_2h, prc_mtbike_3h, prc_mtbike_6h, prc_mtbike_day) VALUES (:car15, :car30, :car1h, :car2h, :car3h, :car6h, :carDay, :mtbike15, :mtbike30, :mtbike1h, :mtbike2h, :mtbike3h, :mtbike6h, :mtbikeDay)");
